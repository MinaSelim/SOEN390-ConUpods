...
public class ConcreteBuilding {
    ...
    public void CCBuilding(){
        ...
        assertEquals(new LatLng(45.458204,-73.6403),CC.getLatLng());
        assertEquals(new LatLng(45.45863873466155,-73.64075660705566),CC.getOverlayLatLng());
    }
    ...
    public void VLBuilding(){
        ...
        assertEquals(new LatLng(45.459026, -73.638606),VL.getLatLng());
        assertEquals(new LatLng(45.45890400660071, -73.63919287919998),VL.getOverlayLatLng());
    }
    ...
    public void MBBuilding(){
        ...
        assertEquals(new LatLng(45.495304, -73.579044),MB.getLatLng());
        assertEquals(new LatLng(45.49575150228435, -73.5789343714714),MB.getOverlayLatLng());
    }
    ...
    public void HallBuilding(){
        ...
        assertEquals(new LatLng(45.497092,-73.5788),H.getLatLng());
        assertEquals(new LatLng(45.497773, -73.579055),H.getOverlayLatLng());
    }
}
